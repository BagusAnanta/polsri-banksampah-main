                            ...
                            <div class="dz-card list">
                                ...
                                <div class="dz-content">
                                    <div class="dz-head">
                                        ...
                                        <ul class="tag-list">
                                            <li>{{ strlen($product->description) > 100 ? Str::limit($product->description, 100) : $product->description }}
                                            </li>
                                        </ul>
                                    </div>
                                    <ul class="dz-meta">
                                    ...
                                    <form class="d-flex align-items-center mt-4 gap-2" action="{{ route('orders.store') }}"
