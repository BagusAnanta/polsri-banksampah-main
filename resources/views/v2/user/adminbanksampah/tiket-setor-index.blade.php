...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @forelse($tikets as $tiket)
            <a href="{{ route('admin.tiket-setor.show', $tiket->tiketsampah_id) }}" data-status="{{ strtolower($tiket->status) }}" class="bg-[#E4CEA5] rounded-xl p-5 border border-slate-200 hover:border-[#A3A85C] transition block">
