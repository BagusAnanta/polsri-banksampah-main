             ...
             <div class="right-content d-flex align-items-center gap-4">
                 @if (Auth::user()->getRoleNames()[0] == 'Admin')
                    ...
                    class="fa fa-trash"></i></a> --}}
                     <form action="{{ route('box-sampahs.destroy', $boxSampah->id) }}" method="post">
                         @csrf
                         @method('DELETE')
                 ...
                 @endif
                 <a href="{{ route('box-sampahs.edit', $boxSampah->id) }}">
             ...
             <ul>
                 <li>
                     <div class="dz-content">
                         ...
                         <h6 class="title">{{ $boxSampah->id_box }}</h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Latitude</p>
                         <h6 class="title">{{ $boxSampah->latitude }}</h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Longitude</p>
                         <h6 class="title">{{ $boxSampah->longitude }}</h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Catatan</p>
                         <h6 class="title">{{ $boxSampah->description }}</h6>
                     </div>
                 </li>
             </ul>
         </div>
