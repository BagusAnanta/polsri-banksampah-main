            ...
            <div class="container py-0">
                <div class="dz-authentication-area">
                    <div class="main-logo">
                        ...
                        <div class="logo">
                            <img src="{{ asset('img') }}/logo-polsri.png" alt="logo">
                            <img src="{{ asset('img') }}/logo-pertamina-ep.png" style="width: 500px;height: 100px"
                                alt="logo">
                        </div>
                    </div>
                    ...
                    <div class="account-section">
                        <form method="POST" action="{{ route('registerUser') }}" class="m-b20">
                            @csrf
                            <div class="mb-4">
