...
<link href="{{ asset('ui/vendor/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
<link href="{{ asset('ui/css/style.css') }}" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.4/jquery-confirm.min.css">
<link href="{{ asset('ui/vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet">
