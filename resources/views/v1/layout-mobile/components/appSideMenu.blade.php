<div class="sidebar dz-floting-sidebar">
    ...
    <ul class="nav navbar-nav">
        ...
        <li>
            <a class="nav-link" href="{{route('monitoring.sensor')}}">
                <span class="dz-icon">
        ...
        <li>
            <a class="nav-link" href="{{route('control.selenoid')}}">
                <span class="dz-icon">
                    <i class="fi fi-rr-dashboard"></i>
                </span>
            ...
            <li>
                <a class="nav-link" href="{{ route('jenis_sampahs.index') }}">
                    <span class="dz-icon">
                        <i class="fi fi-rr-box-open-full"></i>
                    </span>
            ...
            <li>
                <a class="nav-link" href="{{ route('box-sampahs.index') }}">
                    <span class="dz-icon">
                        <i class="fi fi-rr-box-open-full"></i>
                    </span>
            ...
            <li>
                <a class="nav-link" href="{{ route('laporan-pengaduans.index') }}">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a class="nav-link" href="{{ route('bank_sampahs.index') }}">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_329_300)">
            ...
            <li>
                <a class="nav-link" href="{{ route('data-products.index') }}">
                    <span class="dz-icon">
                        <i class="fi fi-rr-cart-shopping-fast"></i>
                    </span>
                    <span>Products</span>
        ...
        @else
            ...
            <li>
                <a class="nav-link" href="{{ route('laporan-pengaduans.indexNasabah') }}">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_329_300)">
