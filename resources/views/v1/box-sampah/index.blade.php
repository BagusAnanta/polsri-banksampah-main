    ...
    <header class="header header-fixed">
        <div class="header-content">
            ...
            <div class="right-content d-flex align-items-center gap-4">
                <a href="{{ route('box-sampahs.create') }}">
...
@section('content')
    <div class="dz-list notification-list">
        <ul>
            @foreach ($boxSampah as $box)
                <li class="list-items pull_delete" onclick="location.href='{{ route('box-sampahs.show', $box->id) }}'">
                    <div class="media">
                        <div class="list-content">
                            <h5 class="title">{{ ucfirst($box->id_box) }}</h5>
                            <span class="date">{{ $box->description }}</span>
                        </div>
                    </div>
                </li>
            @endforeach
