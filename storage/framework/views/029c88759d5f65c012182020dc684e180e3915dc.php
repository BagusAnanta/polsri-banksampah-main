     ...
     <header class="header header-fixed">
         <div class="header-content">
             ...
             <div class="right-content d-flex align-items-center gap-4">
                 ...
                 <form action="<?php echo e(route('laporan-pengaduans.destroy', $laporan->id)); ?>" method="post">
                     <?php echo csrf_field(); ?>
                 ...
                 <a href="<?php echo e(route('laporan-pengaduans.edit', $laporan->id)); ?>">
...
<?php echo $__env->make('layout-mobile.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/polsri-banksampah.grootech.id/resources/views/laporan-pengaduan/show.blade.php ENDPATH**/ ?>