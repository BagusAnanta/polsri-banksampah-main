         ...
         <div class="header-content">
             ...
             <div class="right-content d-flex align-items-center gap-4">
                 <?php if(Auth::user()->getRoleNames()[0] == 'Admin'): ?>
                     ...
                     <form action="<?php echo e(route('jenis_sampahs.destroy', $jenis_sampah->id)); ?>" method="post">
                         <?php echo csrf_field(); ?>
                 ...
                 <?php endif; ?>
                 <a href="<?php echo e(route('jenis_sampahs.edit', $jenis_sampah->id)); ?>">
             ...
             <ul>
                 <li>
                     <div class="dz-content">
                         ...
                         <h6 class="title"><?php echo e($jenis_sampah->nama); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Satuan</p>
                         <h6 class="title"><?php echo e($jenis_sampah->gramasi); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Harga Satuan</p>
                         <h6 class="title"><?php echo e('Rp. ' . $jenis_sampah->harga); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                 ...
                 <li>
                     <div class="dz-content">
                         ...
                         <h6 class="title"><?php echo e($jenis_sampah->catatan); ?></h6>
                     </div>
                 </li>
             </ul>
         </div>
...
<?php echo $__env->make('layout-mobile.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/jenis-sampah/show.blade.php ENDPATH**/ ?>