...
<a href="<?php echo e(route($route)); ?>"
   ...
   class="group relative flex h-10 w-10 items-center justify-center rounded-full transition-all duration-200
          <?php echo e($isActive ? 'bg-olive-700 text-white' : 'text-base-content/60 hover:bg-base-300/50'); ?>">
    ...
    <div>
        ...
        <?php elseif($icon === 'question-mark-circle'): ?>
...
</a><?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/components/layouts/nav-icon.blade.php ENDPATH**/ ?>