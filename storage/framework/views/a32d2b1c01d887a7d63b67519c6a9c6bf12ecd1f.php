...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.layouts.app','data' => ['title' => 'Tiket Setor Sampah','subtitle' => ($tikets ?? collect())->count() . ' tiket tercatat']]); ?>
<?php $component->withName('layouts.app'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Tiket Setor Sampah','subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(($tikets ?? collect())->count() . ' tiket tercatat')]); ?>

     <?php $__env->slot('actions', null, []); ?> 
        <a href="<?php echo e(route('tiket-sampah.create')); ?>"
            ...
            <div class="overflow-hidden rounded-xl bg-base-200/50 transition hover:bg-base-200">
                <div class="p-3 sm:p-4">
                    <div class="mb-3 flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-base-content sm:text-sm">Tiket #<?php echo e($tiket->tiketsampah_inc); ?></p>
                    ...
                    <div class="mb-3 flex flex-wrap gap-2 text-xs">
                        ...
                        <?php endif; ?>
                        <span class="rounded-full bg-base-300/50 px-2.5 py-0.5"><?php echo e(number_format($tiket->berat_sampah ?? 0)); ?>g est.</span>
                    </div>

                    <?php if(strtolower($tiket->status) === 'menunggu'): ?>
                        <div class="flex flex-col gap-2 sm:flex-row">
                            <button class="btn btn-outline btn-sm flex-1 rounded-lg text-xs" 
                                    onclick="document.getElementById('qr_modal_<?php echo e($tiket->tiketsampah_id); ?>').showModal()">
                                📱 Tampilkan QR
                            </button>
                            <form method="POST" action="<?php echo e(route('tiket-sampah.cancel', $tiket->tiketsampah_id)); ?>" class="flex-1">
                                <?php echo csrf_field(); ?>
                        ...
                        <dialog id="qr_modal_<?php echo e($tiket->tiketsampah_id); ?>" class="modal">
                            <div class="modal-box w-full max-w-xs">
                                <h3 class="text-lg font-bold">QR Code Tiket</h3>
                                <div class="py-4 text-center">
                                    <div id="qr_<?php echo e($tiket->tiketsampah_id); ?>" class="mx-auto"></div>
                                    <p class="mt-2 text-sm text-base-content/60">Tiket #<?php echo e($tiket->tiketsampah_inc); ?></p>
                                </div>
                        ...
                        <script>
                            new QRCode(document.getElementById("qr_<?php echo e($tiket->tiketsampah_id); ?>"), {
                        ...
                        <?php $__env->stopPush(); ?>
                    <?php else: ?>
                        <a href="<?php echo e(route('tiket-sampah.show', $tiket->tiketsampah_id)); ?>" class="btn btn-outline btn-sm w-full rounded-lg text-xs">
                            Lihat Detail
                        </a>
                    <?php endif; ?>
                </div>
...
<?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/v2/user/masyarakat/tiket-sampah-index.blade.php ENDPATH**/ ?>