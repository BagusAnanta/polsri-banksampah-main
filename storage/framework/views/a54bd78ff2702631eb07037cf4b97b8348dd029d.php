        ...
        <li class="list-items pull_delete" onclick="location.href='<?php echo e(route('users.show', $user->id)); ?>'">
            <div class="media">
                ...
                <div class="list-content">
                    ...
                    <span class="date"><?php echo e($user->getRoleNames()[0]); ?></span>
                </div>
            </div>
        </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout-mobile.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/polsri-banksampah.grootech.id/resources/views/users/index.blade.php ENDPATH**/ ?>