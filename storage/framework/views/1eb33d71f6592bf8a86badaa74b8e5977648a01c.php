             ...
             <div class="right-content d-flex align-items-center gap-4">
                 <?php if(Auth::user()->getRoleNames()[0] == 'Admin'): ?>
                     <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="post">
                         ...
                         <button type="submit" style="padding-right: 0 !important;" class="btn"
 ...
 <?php $__env->startSection('content'); ?>
     <div class="profile-area">
         <div class="author-bx">
             <div class="dz-media ">
                 <img src="<?php echo e(asset('ui/images/profile/' . ($user->avatar ?? 'user.png'))); ?>">
             </div>
         ...
         <div class="widget_getintuch pb-15">
             <ul>
                 <li>
                     <div class="icon-bx">
                         <svg class="svg-primary" enable-background="new 0 0 507.983 507.983" height="24"
                             viewBox="0 0 507.983 507.983" width="24" xmlns="http://www.w3.org/2000/svg">
                             <path
                     ...
                     <div class="dz-content">
                         <p class="sub-title">Nomor Telepon</p>
                         <h6 class="title"><?php echo e($user->phone); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="icon-bx">
                         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#04764E" width="24"
                             height="24">
                             <path
                                 d="M22 4H2C.897 4 0 4.897 0 6v12c0 1.103.897 2 2 2h20c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zM2 8h20v2H2V8zm0 10V12h20l.002 6H2z" />
                         </svg>
                     </div>
                     <div class="dz-content">
                         <p class="sub-title">No Rekening</p>
                         <h6 class="title"><?php echo e($user->no_rekening); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="icon-bx">
                         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#04764E" width="24"
                             height="24">
                             <path d="M12 2L1 9h22L12 2zm-9 8v10h4V10H3zm6 0v10h6V10H9zm8 0v10h4V10h-4zm-4-6l7 5H5l7-5z" />
                         </svg>
                     </div>
                     <div class="dz-content">
                         <p class="sub-title">Bank</p>
                         <h6 class="title"><?php echo e($user->bank); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="icon-bx">
                     ...
                     <div class="dz-content">
                         ...
                         <h6 class="title"><?php echo e($user->email); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="icon-bx">
                     ...
                     <div class="dz-content">
                         <p class="sub-title">Alamat</p>
                         <h6 class="title"><?php echo e($user->address); ?></h6>
                     </div>
                 </li>
             </ul>
         </div>
...
<?php echo $__env->make('layout-mobile.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/users/show.blade.php ENDPATH**/ ?>