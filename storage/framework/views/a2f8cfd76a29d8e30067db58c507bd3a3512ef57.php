    ...
    <div class="min-h-screen bg-[#FAF5EB]">
        ...
        <div class="bg-white border-b border-stone-200">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-ghost btn-sm gap-2 text-stone-500 hover:text-red-600">
                    ...
                    <div class="card bg-[#EADDCD] rounded-2xl p-7">
                        <div class="card-body p-0">
                            ...
                            <p class="text-sm text-[#5B6E33] font-medium">
                                Selamat datang, <span class="font-semibold"><?php echo e(session('user_name', 'Calon Anggota')); ?></span> 👋
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm font-medium text-stone-800"><?php echo e(session('user_name', '—')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    <div class="h-8 w-8 rounded-full bg-[#FAF5EB] flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm font-medium text-stone-800"><?php echo e(session('user_nik', '—')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    <div class="h-8 w-8 rounded-full bg-[#FAF5EB] flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm font-medium text-stone-800"><?php echo e(session('user_email', '—')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="card bg-[#EADDCD] rounded-2xl p-7">
                        <div class="card-body p-0">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-block btn-sm rounded-full bg-stone-200 text-stone-600 border-none hover:bg-stone-300 text-sm mt-4">
        ...
        <div class="text-center py-6">
            <p class="text-xs text-stone-400">&copy; <?php echo e(date('Y')); ?> Bank Sampah. Hak cipta dilindungi.</p>
        </div>
    </div>
...
<?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/views2/waiting/waiting.blade.php ENDPATH**/ ?>