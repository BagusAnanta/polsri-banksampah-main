<div class="sidebar dz-floting-sidebar">
    <div class="sidebar-header">
        ...
        <div class="title-bar mb-0">
            <h4 class="title font-w600">Menu Utama</h4>
    ...
    <ul class="nav navbar-nav">
        ...
        <li>
            <a class="nav-link" href="<?php echo e(route('maps')); ?>">
                ...
                <span>Lokasi Box Sampah</span>
            </a>
        </li>
        <?php if(Auth::user()->hasRole('Admin')): ?>
        <li>
            <a class="nav-link" href="<?php echo e(route('monitoring.sensor')); ?>">
                <span class="dz-icon">
        ...
        <li>
            <a class="nav-link" href="<?php echo e(route('control.selenoid')); ?>">
                <span class="dz-icon">
                    <i class="fi fi-rr-dashboard"></i>
                </span>
                <span>Kontrol Selenoid</span>
            </a>
        </li>
            <li>
                <a class="nav-link" href="<?php echo e(route('jenis_sampahs.index')); ?>">
                    <span class="dz-icon">
                        <i class="fi fi-rr-box-open-full"></i>
                    </span>
            ...
            <li>
                <a class="nav-link" href="<?php echo e(route('box-sampahs.index')); ?>">
                    <span class="dz-icon">
                        <i class="fi fi-rr-box-open-full"></i>
                    </span>
                    <span>Box Sampah</span>
                </a>
            </li>
            <li>
                <a class="nav-link" href="<?php echo e(route('laporan-pengaduans.index')); ?>">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a class="nav-link" href="<?php echo e(route('bank_sampahs.index')); ?>">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_329_300)">
                    ...
                    <span>Penyetoran Nasabah</span>
                </a>
            </li>
            <li>
                <a class="nav-link" href="<?php echo e(route('transaksi.admin.index')); ?>">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_329_300)">
            ...
            <li>
                <a class="nav-link" href="<?php echo e(route('data-products.index')); ?>">
                    <span class="dz-icon">
                        <i class="fi fi-rr-cart-shopping-fast"></i>
                    </span>
                    <span>Products</span>
            ...
            <li>
                <a class="nav-link" href="<?php echo e(route('departements.index')); ?>">
                    <span class="dz-icon">
        ...
        <?php else: ?>
            ...
            <li>
                <a class="nav-link" href="<?php echo e(route('orders.my-orders')); ?>">
                    <span class="dz-icon">
                        <i class="fi fi-rr-cart-shopping-fast"></i>
                    </span>
                    <span>My Order</span>
            ...
            <li>
                <a class="nav-link" href="<?php echo e(route('laporan-pengaduans.indexNasabah')); ?>">
                    <span class="dz-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_329_300)">
...
<?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/layout-mobile/components/appSideMenu.blade.php ENDPATH**/ ?>