    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-[6fr_4fr] bg-[#FAF5EB]">
        ...
        <div class="flex flex-col justify-start px-6 sm:px-12 lg:px-16 py-8">
            <div class="w-full max-w-md mx-auto">
                ...
                <!-- Form -->
                <form method="POST" action="<?php echo e(route('registerUser')); ?>" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.ktp-upload','data' => ['name' => 'foto_ktp']]); ?>
<?php $component->withName('ktp-upload'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'foto_ktp']); ?>
...
<?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/views2/auth/register.blade.php ENDPATH**/ ?>