         ...
         <div class="header-content">
             ...
             <div class="right-content d-flex align-items-center gap-4">
                 <?php if(Auth::user()->getRoleNames()[0] == 'Admin'): ?>
                     ...
                     <form action="<?php echo e(route('box-sampahs.destroy', $boxSampah->id)); ?>" method="post">
                         <?php echo csrf_field(); ?>
                 ...
                 <?php endif; ?>
                 <a href="<?php echo e(route('box-sampahs.edit', $boxSampah->id)); ?>">
             ...
             <ul>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">ID Sampah</p>
                         <h6 class="title"><?php echo e($boxSampah->id_box); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Latitude</p>
                         <h6 class="title"><?php echo e($boxSampah->latitude); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Longitude</p>
                         <h6 class="title"><?php echo e($boxSampah->longitude); ?></h6>
                     </div>
                 </li>
                 <li>
                     <div class="dz-content">
                         <p class="sub-title">Catatan</p>
                         <h6 class="title"><?php echo e($boxSampah->description); ?></h6>
                     </div>
                 </li>
             </ul>
         </div>
...
<?php echo $__env->make('layout-mobile.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/box-sampah/show.blade.php ENDPATH**/ ?>