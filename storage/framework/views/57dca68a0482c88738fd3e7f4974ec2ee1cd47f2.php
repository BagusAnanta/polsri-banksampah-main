                    ...
                    <div class="form-control">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="password"
                                   ...
                                   class="input input-bordered rounded-xl bg-[#EADDCD] text-sm placeholder-stone-400 w-full pr-12 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
<?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/views2/auth/login.blade.php ENDPATH**/ ?>