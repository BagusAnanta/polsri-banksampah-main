		...
		<div class="header-content">
			...
			<div class="right-content d-flex align-items-center gap-4">
                <?php if(Auth::user()->getRoleNames()[0] == 'Admin'): ?>
                    ...
                    <form action="<?php echo e(route('departements.destroy', $departement->id)); ?>" method="post"> 
                        <?php echo csrf_field(); ?> 
                        <?php echo method_field("DELETE"); ?>         
                        <button type="submit" style="padding-right: 0 !important;" class="btn" onclick="return confirm('Apa Anda yakin ingin menghapus data ini?')" class="dropdown-item">Hapus</button>
                     </form>
                <?php endif; ?>
				<a href="<?php echo e(route('departements.edit', $departement->id)); ?>">
            ...
            <ul>
                <li>
                    <div class="dz-content">
                        ...
                        <h6 class="title"><?php echo e($departement->name); ?></h6>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <?php $__env->stopSection(); ?>
	<!-- Main Content End -->
<?php echo $__env->make('layout-mobile.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bagusanantahidayatullah/BagusFile/FileKerjaBagus/polsri-banksampah-main/resources/views/departements/show.blade.php ENDPATH**/ ?>